...
**Status: proposed** on every item unless noted otherwise (R1, R10, and R12 are done — see those sections). Where a section says "open question," that's a real fork the maintainer hasn't resolved yet — raise it in your PR/issue rather than guessing.
...
## R12 — Adopt Karpathy's "Think Before Coding" + "Surgical Changes" as new house rules; explicitly skip the rest — ✅ Done (forge 1.6.0)
